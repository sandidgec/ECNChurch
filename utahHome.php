...
<head>
    ...
    <link href="/lib/css/stylestchris.css" rel="stylesheet">

    <title>St. Christopher's - E.C.N.</title>
</head>
<body>
...
<div class="hero-unit" id="bunniesjoe">
    ...
    <div class="row">
        ...
        <h2>Welcome to the St. Christopher's Page</h2>
                    ...
                    <div id="search">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <h6>3309 E. Hwy. 162</h6>
                                <h6> P.O. Box 28</h6>
                                <h6>Bluff, Utah 84512</h6>

                            </div>
                            <div class="col-lg-4">
                                <h3>Service Time</h3>
                                <h6>9 A.M. - 10 A.M. Every Sunday</h6>

                            </div>
                            <div class="col-lg-4">
                                <h3>Programs</h3>
                                <h6>Blue Corn Project</h6>
