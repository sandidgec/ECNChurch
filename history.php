...
<head>
    ...
    <style>
        body {
            background-image: url("/lib/img/historybackground.jpg");
        }
        .container {
    ...
    <div id="accordion" class="panel-group">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title"><a href="#collapseOne" data-toggle="collapse" data-parent="#accordion" class="collapsed"> We call ourselves ‘The Dine’ </a></h4>
            </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title"><a href="#collapseFour" data-toggle="collapse" data-parent="#accordion" class="collapsed"> In 1894, The Episcopal Church ... </a></h4>
            </div>
