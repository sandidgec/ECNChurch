...
<div class="row" id="learn-more">
    ...
    <div class="col-lg-4">
        ...
        <dl>
            <dt>Rev. Deacon Paula Henson</dt>
            <dd>Office No. (928) 729-2322</dd>
            <dd>E-Mail. officegoodshepherdmission@gmail.com</dd>
        </dl>
    ...
    <div class="col-lg-4">
        <h3>Good Shepherd Mission</h3>
        <h6>1 Kit Carson Drive</h6>
        <h6>Phone:(928) 729-2322</h6>
        <h6>P.O. Box 618</h6>
        <h6>Fort Defiance, AZ 86504</h6>
        ...
        <dl id="space">
            ...
            <dd>Office No. (928) 729-2322</dd>
            <dd>Email: vicargoodshepherdmission@gmail.com</dd>
            <dd>Priest In Charge Good Shepherd Mission</dd>
            <br>
            <dt>Rev. Deacon Paula Henson </dt>
            <dd>Office No. (928) 729-2322</dd>
            <dd>E-Mail. officegoodshepherdmission@gmail.com</dd>
            <dd>Mission Coordinator</dd>
            <br>
            <a href="http://www.goodshepmission.org" type="button" class="btn btn-primary">Good Shepherd Mission</a>
    ...
    <div class="col-lg-4">
        ...
        <dl>
            ...
            <dd>Office No. (928) 729-2322</dd>
            <dd>P.O. Box 618</dd>
            <dd>Fort Defiance, AZ 86504</dd>
            <dd>Priest In Charge at St. Mark's</dd>
        </dl>
